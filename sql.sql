...
-- 8. What are the top 3  most purchased products within each segement?
with item_counts as (
select category,
item_purchased,
...
-- 9. Are customers repeat buyers (more than 5 previous purchases) also likely to subscribe?
select subscription_status,
